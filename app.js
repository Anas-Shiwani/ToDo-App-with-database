...
const firebaseConfig = {
  apiKey: "AIzaSyDF_YUW-0TYenwcj76m5Vul2mga5S18Cbg",
  authDomain: "todo-app-with-firebase-007.firebaseapp.com",
  databaseURL: "https://todo-app-with-firebase-007-default-rtdb.firebaseio.com",
  projectId: "todo-app-with-firebase-007",
  storageBucket: "todo-app-with-firebase-007.appspot.com",
  messagingSenderId: "586377445798",
  appId: "1:586377445798:web:de0045852af22c983e0f67",
  measurementId: "G-056T4CYR7C"
};
...
form.addEventListener("submit", (e) => {
  ...
  if(emailInput.classList.contains("valid") && fullName.classList.contains("valid") && password.classList.contains("valid")){
    ...
    setTimeout(() => {
      window.location.href = '/tokens/ToDoApp/index.html';
      //redirecting to the todoapp page
    }, 13000);
  }
